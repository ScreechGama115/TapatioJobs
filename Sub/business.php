    ...
    if ($_POST['guardar']) {
      if ($_POST['password'] == $_POST['passwordconfirm']) {
              ...
              <?php }
            		...
            		$ib = mysql_query("INSERT INTO business (name,password,username,type,telefono1,telefono2,avatar,muro,name_admin,email,ubicacion,servicio,descripcion,fecha) values ('$empresa','$password','$username',1,'$telefono1','$telefono2','$destino1','$destino2','$name_admin','$email','$ubicacion','$servicio','$descripcion',NOW())");
            		if ($ib && $it) { ?>
                <script type="text/javascript">
