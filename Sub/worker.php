    ...
    if ($_POST['guardar']) {
      if ($_POST['password'] == $_POST['passwordconfirm']) {
              ...
              $debilidades = clean($_POST['debilidades']);
                ...
                $nombrefoto2=$_FILES['muro']['name'];
                $ruta2=$_FILES['muro']['tmp_name'];
                $name2 = $id2.'.'.$tips2;
              ...
              <?php }
            		...
            		$iw = mysql_query("INSERT INTO users (name,password,username,type,edad,avatar,muro,ubicacion,carrera,email,telefono1,telefono2,experiencia,habilidades,software,debilidades,descripcion,fecha) values ('$nombre','$password','$username',2,'$edad','$destino1','$destino2','$ubicacion','$carrera','$email','$telefono1','$telefono2','$experiencia','$habilidades','$software','$debilidades','$descripcion',NOW())");
                if ($iw) { ?>
                <script type="text/javascript">
